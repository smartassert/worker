...
ARG EXECUTION_COMPLETED_CHECK_PERIOD_MS=1000
ARG STATE_NOTIFY_SECRET=state_notify_secret
...
ENV EXECUTION_COMPLETED_CHECK_PERIOD_MS=$EXECUTION_COMPLETED_CHECK_PERIOD_MS
ENV STATE_NOTIFY_SECRET=$STATE_NOTIFY_SECRET
